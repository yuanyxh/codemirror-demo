import { EditorState, StateCommand, Extension } from "@/state/index";
import {
  indentMore,
  indentLess,
  indentSelection,
...
describe("commands", () => {
  describe("indentMore", () => {
    function test(from: string, to: string) {
      ist(stateStr(cmd(mkState(from), indentMore)), to);
    }
  ...
  describe("indentLess", () => {
    function test(from: string, to: string) {
      ist(stateStr(cmd(mkState(from), indentLess)), to);
    }
  ...
  describe("insertNewlineKeepIndent", () => {
    ...
    it("keeps indentation", () => test("  one|", "  one\n  |"));
